...
\]
\end{definition}
Estas filtraciones pueden ser obtenidas de diversas formas. Por un lado, podremos obtener filtraciones variando el radio de los complejos de \v{C}ech, Vietoris-Rips y alfa complejos; y más adelante veremos cómo obtener filtraciones de complejos simpliciales más generales a partir de la filtración por las estrellas inferiores de una función PL.
